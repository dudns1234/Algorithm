...
#         for row in range(N):
#           for col in range(N):
#             check_list[row][col] =  True  # 2(row=0,col=0)(row=1,col=1)(row=1,col=2),(row=2,col=2)(row=2,col=1)
#             temp.append(series[row][col])  # 2(1,2), 0(2,3), 2
#     #print(now)
    ...
    #         for col in range(N):
    #             if 
    #         for link in series[row]:
    #           if series[row].index(link) != 
    #            if not check_list[link]:
    #                 dfs(link)

    # for col in series[0]:
    #     print(col)
    #     print(series[0].index(col))
        #dfs(col)
